...
-   Verwenden Sie nach Möglichkeit Werte desselben Datentyps, damit [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] keine Konvertierung vornehmen muss.  
