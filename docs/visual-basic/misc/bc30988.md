...
```  
 ...
 Beginnend mit [!INCLUDE[vb_orcas_long](../../visual-basic/misc/includes/vb_orcas_long_md.md)] können Sie ein Objekt als eine Instanz eines anonymen Typs deklarieren. In diesem Fall geben Sie keinen Datentyp an. In Deklarationen anonymer Typen folgt das Schlüsselwort `With` auf `New`.  
