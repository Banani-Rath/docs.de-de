...
Eine [!INCLUDE[dnprdnshort](../../csharp/getting-started/includes/dnprdnshort_md.md)]\-Komponente, die eine oder mehrere generische Prozeduren enthält, wird in eine COM\-Komponente exportiert.  
