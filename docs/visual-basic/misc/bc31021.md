...
Der [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]\-Compiler kann nach folgendem Fehler nicht wiederhergestellt werden: \<`error`\>.  
  
 Einige IDE\-Features wurden deaktiviert.  
  
 Ein interner Fehler ist im [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]\-Compiler aufgetreten.  
