...
1.  Führen Sie Dateivorgänge mit den Membern der Laufzeitfunktionen `System.IO`, `FileSystemObject` und [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] aus.  
