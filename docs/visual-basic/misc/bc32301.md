...
Innerhalb des [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)]\-Compilers ist beim Zugriff auf das Codemodell ein Fehler aufgetreten.  
