...
Bei den folgenden Operatoren handelt es sich um verschiedene in [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] definierte Operatoren.  
